...
branch. Each command prints a suggestion for the next one, so you can follow the
...
nosedive test --full                # still red, now for the reason the
                                    # gate checks

# satisfy it in workspace/__self and commit there

...
token secrets. [`.github/workflows/ci.yml`](.github/workflows/ci.yml) typechecks, builds, and smoke-tests the CLI ([`src/nosedive.ts`](src/nosedive.ts)) on PRs & pushes to `main`.

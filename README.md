...
| [`preflight@2`](kb/67187c8d-2e4e-5fc5-b8fd-d0805acd0f2e.md) | `npx nosedive preflight` | Confirm the bridge pre-push hook is wired, fetch bridge trunk, then print the session-start report -- bridge status, pilot identity, and open work. |

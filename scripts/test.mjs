...
`,
  ...
  assert.match(bodyDoc, /^<!-- CLAUDE\.md: Generated by nosedive, do not edit by hand\. -->\n\n---\neffort: "yaml-frontmatter\/YamlFrontmatter\.md"\nrepo-id: "repo-writable"\nscope-path: "app"\n---/);
  ...
  assert.match(readOnlyDoc, /^<!-- CLAUDE\.md: Generated by nosedive, do not edit by hand\. -->\n\n---\neffort: "yaml-frontmatter\/YamlFrontmatter\.md"\nrepo-id: "repo-readonly"\nscope-path: "app"\n---/);
...
`,
  ...
  assert.doesNotMatch(activeDoc, /^<!-- CLAUDE\.md: Generated by nosedive, do not edit by hand\. -->\n\n---/);

...
import { run as i14cbfa07d01f51e9b5aaca0451613df4 } from "./i14cbfa07d01f51e9b5aaca0451613df4.js";
...
import { run as ia4b29088966a53d39c14a03500a73681 } from "./ia4b29088966a53d39c14a03500a73681.js";
...
import { run as i1c017216b4be57978452eb5d7a481ddc } from "./i1c017216b4be57978452eb5d7a481ddc.js";
import { run as i2dce2285fdf7576d8df6b705ed9eb831 } from "./i2dce2285fdf7576d8df6b705ed9eb831.js";
import { run as ie7e643e86f755b839ca101c0027834cc } from "./ie7e643e86f755b839ca101c0027834cc.js";
import { run as if96566c2381e5327a1296d254870157c } from "./if96566c2381e5327a1296d254870157c.js";
import { run as i920b7cd2b81052f288b01b56dcd9ffc0 } from "./i920b7cd2b81052f288b01b56dcd9ffc0.js";
...
import { run as i55dbde28c4d15a1f9a1cff54dc203cc8 } from "./i55dbde28c4d15a1f9a1cff54dc203cc8.js";
import { run as i4902e2824ecd5d1fa7df1745486d00a9 } from "./i4902e2824ecd5d1fa7df1745486d00a9.js";
import { run as i72d9929a36175ba6a4a6c9eca48d3fc8 } from "./i72d9929a36175ba6a4a6c9eca48d3fc8.js";
import { run as i13819edb8475569d8906310bdb0ebc8e } from "./i13819edb8475569d8906310bdb0ebc8e.js";
import { run as i0995c54d2e345db7839c9268c38c3ab0 } from "./i0995c54d2e345db7839c9268c38c3ab0.js";
import { run as i56234ba315d45b719a2b0149c885d328 } from "./i56234ba315d45b719a2b0149c885d328.js";
import { run as iea60fb735ccf53159bafc924926aa3fe } from "./iea60fb735ccf53159bafc924926aa3fe.js";
import { run as i5146ad0edc5250b8a4e5f72792128cd3 } from "./i5146ad0edc5250b8a4e5f72792128cd3.js";
import { run as i9a8b1978632956e69d48107f74a456d5 } from "./i9a8b1978632956e69d48107f74a456d5.js";
...
export function createImplRegistry(runtime: ImplRuntime) {
	return {
		...
		i14cbfa07d01f51e9b5aaca0451613df4: (args: string[]) =>
			i14cbfa07d01f51e9b5aaca0451613df4(args, runtime),
		...
		ia4b29088966a53d39c14a03500a73681: (args: string[]) =>
			ia4b29088966a53d39c14a03500a73681(args, runtime),
		...
		i1c017216b4be57978452eb5d7a481ddc: (args: string[]) =>
			i1c017216b4be57978452eb5d7a481ddc(args, runtime),
		i2dce2285fdf7576d8df6b705ed9eb831: (args: string[]) =>
			i2dce2285fdf7576d8df6b705ed9eb831(args, runtime),
		ie7e643e86f755b839ca101c0027834cc: (args: string[]) =>
			ie7e643e86f755b839ca101c0027834cc(args, runtime),
		if96566c2381e5327a1296d254870157c: (args: string[]) =>
			if96566c2381e5327a1296d254870157c(args, runtime),
		i920b7cd2b81052f288b01b56dcd9ffc0: (args: string[]) =>
			i920b7cd2b81052f288b01b56dcd9ffc0(args, runtime),
		...
		i1c0a2194ba665e13a6bbebcf5033acaf: (args: string[]) =>
			i1c0a2194ba665e13a6bbebcf5033acaf(args, runtime),
		...
		ic76b835ecbcb559080b2aee1b405babf: (args: string[]) =>
			ic76b835ecbcb559080b2aee1b405babf(args, runtime),
		idfa77573dddc590cb8f5f5ff784c3384: (args: string[]) =>
			idfa77573dddc590cb8f5f5ff784c3384(args, runtime),
		i55dbde28c4d15a1f9a1cff54dc203cc8: (args: string[]) =>
			i55dbde28c4d15a1f9a1cff54dc203cc8(args, runtime),
		i4902e2824ecd5d1fa7df1745486d00a9: (args: string[]) =>
			i4902e2824ecd5d1fa7df1745486d00a9(args, runtime),
		i72d9929a36175ba6a4a6c9eca48d3fc8: (args: string[]) =>
			i72d9929a36175ba6a4a6c9eca48d3fc8(args, runtime),
		i13819edb8475569d8906310bdb0ebc8e: (args: string[]) =>
			i13819edb8475569d8906310bdb0ebc8e(args, runtime),
		i0995c54d2e345db7839c9268c38c3ab0: (args: string[]) =>
			i0995c54d2e345db7839c9268c38c3ab0(args, runtime),
		i56234ba315d45b719a2b0149c885d328: (args: string[]) =>
			i56234ba315d45b719a2b0149c885d328(args, runtime),
		iea60fb735ccf53159bafc924926aa3fe: (args: string[]) =>
			iea60fb735ccf53159bafc924926aa3fe(args, runtime),
		i5146ad0edc5250b8a4e5f72792128cd3: (args: string[]) =>
			i5146ad0edc5250b8a4e5f72792128cd3(args, runtime),
		i9a8b1978632956e69d48107f74a456d5: (args: string[]) =>
			i9a8b1978632956e69d48107f74a456d5(args, runtime),
		id2f5b8bbdf015307867807ad3107a44c: (args: string[]) =>
			id2f5b8bbdf015307867807ad3107a44c(args, runtime),
		ie4616d52d0ef552ba573e76c80480966: (args: string[]) =>
		...
		i186faaff79175065bcda163fa43c2b44: (args: string[]) =>
			i186faaff79175065bcda163fa43c2b44(args, runtime),
		i00671103fb8b50d89ffc60e3eb0f4745: (args: string[]) =>
			i00671103fb8b50d89ffc60e3eb0f4745(args, runtime),
		iaec7a02f29625c9b98be0cbc193fe346: (args: string[]) =>
			iaec7a02f29625c9b98be0cbc193fe346(args, runtime),
		ic50d2e5d17cf5789831eba10360ce604: (args: string[]) =>

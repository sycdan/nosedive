...
import { UUID7_MAX_TIMESTAMP_MS, mintUuid7Lines, uuid7AtMs } from "./uuid7.js";
...
let commandHelpPrinter: ((command: string, io: CommandIo) => void) | undefined;
...
export async function seed(args: string[], io: CommandIo): Promise<void> {
...
export function whoami(args: string[], io: CommandIo): void {
...
export function dumpBacklog(args: string[], io: CommandIo): void {
...
export function dumpBacklogMemo(args: string[], io: CommandIo): void {
...
export function updateBacklog(args: string[], io: CommandIo): void {
...
export function listDives(args: string[], io: CommandIo): void {
...
export function pitch(args: string[], io: CommandIo): void {
...
export function addRepo(args: string[], io: CommandIo): void {
...
export function dehydrateRepoWorkspace(args: string[], io: CommandIo): void {
...
export async function prove(args: string[], io: CommandIo): Promise<void> {
...
export async function proveHost(args: string[]): Promise<void> {
...
export function renderCommand(args: string[], io: CommandIo): void {
	const [id, ...extra] = args;
...
export function preflight(_args: string[], io: CommandIo): void {
	const rc = readNosediveRc(process.cwd());
...
export function prePushHook(_args: string[], io: CommandIo): void {
...
export function nuke(args: string[], io: CommandIo): void {
...
export function apply(args: string[], io: CommandIo): void {
...
export async function runLegacyCommand(
	...
	switch (command) {
		...
		case "dump-backlog":
			dumpBacklog(args, io);
			return true;
		case "dump-backlog.memo":
			dumpBacklogMemo(args, io);
			return true;
		case "update-backlog":
